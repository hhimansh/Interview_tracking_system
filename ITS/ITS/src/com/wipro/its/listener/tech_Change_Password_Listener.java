...
public class tech_Change_Password_Listener implements ActionListener
{
	...
	public tech_Change_Password_Listener(change_pass1 cp) 
	{
		this.cp=cp;
	}
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource()==cp.b1)
		{
			...
			try
			{
				...
				pst.setString(1, TechPanel.userId1);
				rs = pst.executeQuery();
				rs.next();
...
//				e1.printStackTrace();
			...
			cBean.setUserID(TechPanel.userId1);

...
public class HRViewInfoListener implements ActionListener
{
	HRViewInfo info;
	public HRViewInfoListener(HRViewInfo info)
	{
		this.info=info;
	}
	...
	public void actionPerformed(ActionEvent e) 
	{
		if(e.getSource()==info.button)
		{
			...
			HRPanelClass hpc = new HRPanelClass();
			CandidateBean cb = hpc.viewCandidateInfo(candidateID);
			if(cb==null)
			{

...
import com.wipro.its.listener.*;

@SuppressWarnings("serial")
public class HRPanel extends JFrame 
{

	public JLabel l,l1,l2,l3,ab1,ab2,ab3,ab4,ab5,user,ab;
	JPanel panel1,panel2,panel3,panel4,panel5;
	public String str1,str2,str3,str4,str5,str6,str;
	public JLabel label1,imglb;
	ImageIcon img;
	HRPanel_lis hl= new HRPanel_lis(this);
	public static String userId2;

	public HRPanel(String userId2)
	{	
		HRPanel.userId2=userId2;
...
//		panel2.add(l2);
		...
		l1.addMouseListener(hl);
		ab1.addMouseListener(hl);
		ab2.addMouseListener(hl);
		ab3.addMouseListener(hl);
		ab4.addMouseListener(hl);
		ab.addMouseListener(hl);

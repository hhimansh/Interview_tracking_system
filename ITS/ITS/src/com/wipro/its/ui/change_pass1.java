...
import com.wipro.its.listener.tech_Change_Password_Listener;



@SuppressWarnings("serial")
public class change_pass1 extends JFrame{
	JPanel pan;
	...
	tech_Change_Password_Listener ad;




	public change_pass1(String userId1)
	{		

		
		ad= new tech_Change_Password_Listener(this);
		setSize(340,290);
		setLocation(365,265);
		...
		last1.setBounds(40,202,300,20);
		last1.setForeground(Color.RED);
		last2.setLayout(null);
		last2.setBounds(40,222,300,20);
		last2.setForeground(Color.RED);
		last3.setBounds(40,242,300,20);
		last3.setForeground(Color.RED);


		b1.setBounds(140,180,60,20);
